...
@section('title', 'HRMS | إضافة صلاحية')

@section('content')
<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
    <h2 style="margin: 0;">إضافة صلاحية جديدة</h2>
...
<form action="{{ route('roles.store') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" id="name" name="name" placeholder="مثال: HR, مدير, موظف" required>
    </div>
    ...
    <div class="form-group">
        ...
        <textarea id="permissions" name="permissions" rows="5" placeholder='{"employees": ["view", "create"], "leaves": ["view"]}'></textarea>
    </div>
